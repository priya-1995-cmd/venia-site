...
export default async function decorate(block) {
  ...
  topBar.innerHTML = '<div class="header-markets"><span>Main Website Store - Default Store View</span><span class="icon icon-line">|</span><span class="header-chevron-down">$ USD</span></div>';
